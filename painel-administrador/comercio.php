        ...
        function editarComercio(id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    document.getElementById('edit-estado').value = comercio.estado;
                    document.getElementById('edit-telefone').value = comercio.telefone;
                    document.getElementById('edit-categoria').value = comercio.categoria;
                    document.getElementById('edit-redes_sociais').value = comercio.redes_sociais;
    ...
    <div class="modal-content">
        ...
        <form id="CadastrarForm" method="post">
            ...
            <div class="grupo">
                ...
                <select name="comerciante_id" required>
                    <option value="">Selecione</option>
                    <?php
                    include '../config.php';
                    $sql = "SELECT id, nome FROM comerciantes ORDER BY nome ASC";
                    $result = $conn->query($sql);
...
<div id="editModal" class="modal">
    <div class="modal-content">
        ...
        <form id="editForm">
            ...
            <label>Redes Sociais:</label>
            <input type="url" id="edit-redes_sociais" name="redes_sociais" placeholder="https://facebook.com/seuperfil">
